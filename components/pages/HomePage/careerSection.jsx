                ...
                <div className="bannerOverlay h-96 flex flex-col justify-center text-white">
                    <div className="xl:w-10/12 mx-auto px-6 xl:px-0 w-full">
                        <div className="xl:w-7/12 xl:text-3xl flex flex-col space-y-2 text-2xl">
                            ...
                            <h1 className="font-medium xl:text-4xl text-xl">Work on some of Ndara B with DUT&#39;s  most exciting community construction projects in a fast-paced environment where each day brings new challenges</h1>
                        </div>
                        <div className="xl:pt-8 capitalize font-medium xl:text-xl pt-3" id="bannerCta">
                            <Link href="#">
                                ...
                                <span>search and apply for a role with us</span>
