...
import Thumbnail11 from '../../../public/images/thumbnails/thumbnail11.png';
            ...
            <div className="xl:w-10/12 mx-auto px-6 xl:px-0">
                <div className="xl:grid xl:grid-cols-2">
                    <div className="bg-red-200 hidden xl:block relative" style={{height: '500px'}}>
                        <Image src={Thumbnail11} alt="Board" className="w-full h-full" layout='fill'/>
                    </div>
                    <div className="py-20 px-6 bg-stone-100">
                        <div>
                            <h3 className="capitalize font-medium text-stone-700 xl:text-xl">company history</h3>
                            <h1 className="xl:text-4xl text-2xl xl:w-10/12 font-medium text-stone-700 capitalize">We have a proud history, tracing our roots back to companies that began their operations - years</h1>
                        </div>
