            ...
            <div className="w-full aboutBanner bg-cover bg-center h-96">
                 <div className={"bannerOverlay h-96 flex flex-col justify-center text-white"}>
                    ...
                    <div className="xl:w-7/12 xl:text-xl flex flex-col space-y-2 text-xl">
                        ...
                        <h1 className="font-medium xl:text-3xl text-2xl">Our people are passionate about creating vital facilities for the communities we work in</h1>
                    </div>
                    <div className="xl:pt-8 capitalize font-medium xl:text-xl text-sm pt-3 justify" id="bannerCta">
                        <Link href="#">
